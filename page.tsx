...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    url: "https://agent-bot.de/cheatsheet",
    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-black/10 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          ...
          <a
            href="#download"
            className="bg-[#182332] text-white px-4 py-2 text-[11px] font-bold uppercase tracking-[0.15em] hover:bg-[#FF4F15] transition-colors"
          >
            Zum Download
          </a>
        </div>
      ...
      <header className="bg-[#182332] text-white">
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-32">
          <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#FF4F15] mb-6">
            Kostenloses PDF — 9 Seiten
          </p>
          ...
          <p className="max-w-lg text-lg text-white/60 leading-relaxed">
            14 Sektionen. Jeder Befehl mit deutschem Kommentar.
            Fertige Aliases und Shell-Funktionen für die .zshrc.
            Copy-Paste-ready, kein Tutorial-Gelaber.
          </p>
        </div>
      </header>
      ...
      <div className="border-b border-black/10 bg-black/[0.02]">
        <div className="mx-auto max-w-6xl flex flex-wrap">
          {HIGHLIGHTS.map((s) => (
            <div
              key={s.label}
              className="flex-1 min-w-[120px] border-r last:border-r-0 border-black/10 px-6 py-5 text-center"
            >
              <span className="block text-2xl font-black text-[#FF4F15]">
                {s.value}
              </span>
              <span className="mt-1 block text-[10px] uppercase tracking-[0.2em] text-black/40 font-semibold">
                {s.label}
              </span>
            </div>
          ))}
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="text-black/50 mb-12 max-w-lg">
            Alles, was du täglich im Terminal brauchst — von Basics bis
            Production-Grade Docker-Workflows und lokale LLMs.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {SECTIONS.map((section, i) => (
              <div
                key={section}
                className="flex items-start gap-3 border border-black/10 p-4 hover:border-[#FF4F15] transition-colors"
              >
                <span className="text-[11px] font-bold text-[#FF4F15] mt-0.5 shrink-0">
      ...
      <section className="bg-[#182332] text-white px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-black uppercase mb-12">
            Kein 08/15-<span className="text-[#FF4F15]">Cheat Sheet.</span>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Dark-Theme Code-Blöcke",
                desc: "Syntax-Highlighting mit grünen Kommentaren auf dunklem Hintergrund — wie in deinem Editor.",
              },
              {
                title: "Fertige .zshrc-Config",
                desc: "Aliases, Exports und Shell-Funktionen zum direkten Copy-Pasten. Inkl. killport(), project() und dsh().",
              },
              {
                title: "Docker Production-Stack",
                desc: "Multi-Stage Builds, Compose-Orchestrierung, CI/CD-Pipeline und Environment-Strategie — alles auf einer Seite.",
              },
            ].map((item) => (
              <div
                key={item.title}
                className="border border-white/10 p-6 hover:border-[#FF4F15] transition-colors"
              >
      ...
      <section className="px-6 py-20 md:py-28 bg-black/[0.02]">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 text-sm text-black/40">
            Auszug aus Sektion 14 — Power-User: Pipes, Aliases & .zshrc
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="border-2 border-black p-8 md:p-12 shadow-[6px_6px_0px_rgba(0,0,0,1)]">
            <h2 className="text-3xl md:text-4xl font-black uppercase mb-2">
              Hol dir das <span className="text-[#FF4F15]">PDF.</span>
            </h2>
            <p className="text-black/50 mb-8">
              9 Seiten, 14 Sektionen, Dark-Theme, Agent-Bot-Branding.
      ...
      <footer className="border-t border-black/10 px-6 py-8 text-center">
        <p className="text-[11px] text-black/30 mb-2">
          © 2026 Agent Bot · Hannes Schwede
        </p>
        <div className="flex justify-center gap-4 text-[11px] text-black/30">
          <a href="/impressum" className="hover:text-[#FF4F15] transition-colors">
            Impressum
          </a>
          <a href="/datenschutz" className="hover:text-[#FF4F15] transition-colors">
            Datenschutz
          </a>
        </div>
      </footer>
