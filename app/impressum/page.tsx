    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 md:py-24">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-black/80">
          ...
          <section><h2 className="font-bold text-black mb-2">Kontakt</h2><p>E-Mail: <a href="mailto:hannes@agent-bot.de" className="text-[#FF4F15] hover:underline">hannes@agent-bot.de</a></p></section>
